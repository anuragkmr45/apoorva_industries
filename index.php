    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1"
          ...
          <h1>APOORBA INDUSTRIES</h1>
          <h4>Manufacturing Plastic Items</h4>
          <h2> Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quo, unde!
          </h2>
  ...
  <main id="main">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 content" data-aos="fade-left" data-aos-delay="100">
            ...
            <div class="skills-content">
              ...
              <div class="progress">
                <span class="skill">Service 1 <i class="val">100%</i></span>
              ...
              <div class="progress">
                <span class="skill">Service 2 <i class="val">90%</i></span>
                <div class="progress-bar-wrap">
              ...
              <div class="progress">
                <span class="skill">Service 3 <i class="val">75%</i></span>
                <div class="progress-bar-wrap">
              ...
              <div class="progress">
                <span class="skill">Service 4 <i class="val">55%</i></span>
                <div class="progress-bar-wrap">
        ...
        <div class="row">
          <div class="col-xl-3 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon-box">
              ...
              <h4><a href="/service-details.php">Services 1</a></h4>
          ...
          <div class="col-xl-3 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="zoom-in"
            ...
            <div class="icon-box">
              ...
              <h4><a href="service-details.php">Services 2</a></h4>
          ...
          <div class="col-xl-3 col-md-6 d-flex align-items-stretch mt-4 mt-xl-0" data-aos="zoom-in"
            ...
            <div class="icon-box">
              ...
              <h4><a href="service-details.php">Services 3</a></h4>
          ...
          <div class="col-xl-3 col-md-6 d-flex align-items-stretch mt-4 mt-xl-0" data-aos="zoom-in"
            ...
            <div class="icon-box">
              ...
              <h4><a href="service-details.php">Services 4</a></h4>
    ...
    <section id="portfolio" class="portfolio">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Products And Customer Reviews</h2>
          <p>Magnam dolores commodi suscipit. Necessitatibus eius consequatur ex aliquid fuga eum quidem. Sit sint
            consectetur velit. Quisquam quos quisquam cupiditate. Et nemo qui impedit suscipit alias ea. Quia fugiat sit
            in iste officiis commodi quidem hic quas.</p>
        </div>
        ...
        <ul id="portfolio-flters" class="d-flex justify-content-center" data-aos="fade-up" data-aos-delay="100">
          ...
          <li data-filter=".filter-app">product1</li>
          <li data-filter=".filter-card">protect2</li>
          <li data-filter=".filter-web">product3</li>
        </ul>
        ...
        <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            ...
            <div class="portfolio-info">
              ...
              <a href="service-details.php" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-5 d-flex align-items-stretch">
            <div class="info">
              ...
              <iframe
                src="https://www.google.com/maps/place/Andeisahi,+Odisha,+India/@20.4853189,85.9417202,15z/data=!3m1!4b1!4m5!3m4!1s0x3a196d5d5b95e763:0xfbe6983193e68c03!8m2!3d20.4835581!4d85.9534465?hl=en-US"
